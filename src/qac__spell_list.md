...
Can be thrown at a creature to blind it (provided it has eyes, uses them, and they fit in the radius of the ball). The referre may require a DC 6 `DEX` / `Shoot` skill check to "place" the ball at the right place.
